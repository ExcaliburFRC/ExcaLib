package excalib.slam.photon_vision;
...
public class PhotonVision {
    ...
    public PhotonVision() {
        ...
        photonPoseEstimator = new PhotonPoseEstimator(fieldLayout, PhotonPoseEstimator.PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, camera, robotToCamera);
